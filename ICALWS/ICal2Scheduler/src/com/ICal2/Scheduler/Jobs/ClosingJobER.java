...
public class ClosingJobER implements Job{ 
	
	public void execute(JobExecutionContext context) throws JobExecutionException
	{
		System.out.println("Generation Closing Files for ER Zone --->>> Time is " + new Date());
		generateClosingFilesER();
		
	} 
	
	public void generateClosingFilesER()
	{
		System.out.println("inside generateClosingFilesER");
		...
		try
		{
			iList = iservice.getAllLiveIndexForFileGeneration("ER");
