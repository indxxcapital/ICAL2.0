...
public class ClosingJobAR implements Job{ 
	
	public void execute(JobExecutionContext context) throws JobExecutionException
	{
		System.out.println("Generation Closing Files for AR Zone --->>> Time is " + new Date());
		generateClosingFilesAR();
	} 
	
	public void generateClosingFilesAR()
	{
		System.out.println("inside generateClosingFilesAR");
